...
var theForm = document.getElementById( 'theForm' );
      ...
      new stepsForm( theForm, {
        onSubmit : function( form ) {
          ...
          var link="https://docs.google.com/forms/d/e/1FAIpQLScXAHHGnsZJt0rfnMT8_R5j0rRNsAumaCALd4pQchWeW48kuw/viewform?usp=sf_link";
          jQuery.ajax({
                url: link,
      ...
      function numberAnimations() {
        $(window).scroll(function() {
          if ($(".numbers-wrapper").is(":visible") == true) {
            ...
            $("#coded-lines").animateNumber({ number: 12000, numberStep: comma_separator_number_step }, 2000);
            $("#rendered-pixels").animateNumber({ number: 783509, numberStep: comma_separator_number_step }, 2000);
            $("#coffee-cups").animateNumber({ number: 512, numberStep: comma_separator_number_step }, 2000);
            $("#eaten-nutela").animateNumber({ number: 2, numberStep: comma_separator_number_step }, 2000);
